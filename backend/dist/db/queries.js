...
var employeeQuery = "SELECT e.emp_fname, e.emp_lname, i.img, j.job_description, j.job_chg_hour FROM employee e JOIN job j ON e.job_code = j.job_code join img i on i.emp_num = e.emp_num";
var projectQuery = "select e.emp_fname, e.emp_lname, j.job_description, p.proj_name, a.assign_date, assign_chg_hr, a.assign_hours, assign_charge from employee e join assignment a on e.emp_num = a.emp_num join job j on j.job_code = a.assign_job join project p on p.proj_num = a.proj_num order by proj_name";
